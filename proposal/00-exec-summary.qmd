...
the proposal, including its goals, methods, expected outcomes, deliverables,
and budget.
-->
...
We are seeking **USD $<!-- TODO: Budget -->** to fund one developer (Pachá)
for three months <!-- TODO: if this is intended to be your primary income, I think we should say that -->.
