...
### Phase 1: Planning and Analysis (September 2025)

- **Week 1-2:** Complete mapping of the DAP specification to the R REPL browser
  loop, identifying all necessary touchpoints and data requirements
- **Week 3-4:** Deep analysis of existing implementations (`vscDebugger`, `ark`)
...
### Phase 2: Core Infrastructure Development (October - November 2025)

- **Month 2:** Implement enhanced browser hooks in a patched version of R,
  extending beyond current `USE_BROWSER_HOOKS` capabilities
- **Month 3:** Develop the foundational DAP server architecture using `later`
...
### Phase 3: DAP Protocol Implementation (December 2025 - January 2026)

- **Month 4:** Implement core DAP request handlers (threads, stackTrace,
  scopes, variables, evaluate)
- **Month 5:** Add stepping functionality (stepIn, stepOut, stepOver, continue)
  and breakpoint management
- **Deliverable:** Feature-complete DAP server supporting majority of
  protocol specification

### Phase 4: Integration and Testing (February 2026)

- **Month 6:** Comprehensive testing across multiple IDEs (VSCode, vim/neovim,
  emacs), performance optimization, and edge case handling
- **Final weeks:** Documentation, packaging, and preparation for broader
  community feedback
- **Deliverable:** Production-ready R package with comprehensive documentation

### Phase 5: Community Engagement and Handoff (March 2026)
...
available throughout the 6-month development cycle, with structured engagement
at key milestones:

- **Month 2:** Share technical specification and R patch proposal with R Core
- **Month 4:** Interim progress report and community feedback session
- **Month 6:** Final presentation to R Core and broader R community
...
With the extended timeline, we plan quarterly R Consortium blog posts to share:
- **Q4 2025:** Project kickoff and technical approach
- **Q1 2026:** Progress update and early findings
- **Q2 2026:** Final results and next steps for community adoption
...
pacha.dev/blog post (re-post with the R Consortium?)
...
We are proposing work that we expect to take approximately six months, starting
in September 2025. Given the technical complexity and the need for thorough
R Core integration, we are requesting funds to support one developer, Mauricio,
at 50% time for six months. Given the technical breadth and depth of the work,
we are requesting **USD $5,500** to support them through this project.
